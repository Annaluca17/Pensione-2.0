    ...
    autoTable(doc, {
      ...
      body: [
        ...
        ...(tfsMC
          ...
          : [[{ content:'TFS — Confronto non applicabile (cessazione ante 01/01/2024)', colSpan:5, styles:{fontStyle:'italic' as const,textColor:[120,53,15] as [number,number,number]} }]]),
      ],
      styles:{fontSize:7.5},
